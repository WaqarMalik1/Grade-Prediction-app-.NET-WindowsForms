...
{
    public partial class AddModuleFormLevel6 : Form
    {
        ...
        public AddModuleFormLevel6()
        {
            InitializeComponent();
        }

        private void AddModuleFormLevel6_Load(object sender, EventArgs e)
        {
            //Form Load Method

            //Setting labels to be invisible
        ...
        private void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            //It also makes sure the Level saved is 6
            ...
            if (CheckingWeighting == true)
            {
                ...
                createCommand.Parameters.AddWithValue("@Level", "6");
